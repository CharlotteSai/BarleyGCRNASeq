...
goRes_filter <- names(goRes) %>% 
  ...
  lapply(function(x){
    x %>% 
      ...
      # filter(!(str_detect(Description,                          "development|morphogenesis|cardioblast|cardiocyte|muscle|heart|animal|determination| cell |synapse")))
...
go2Gene[["GO:0016301"]] # down


# ABA
go2Gene[["GO:0006468"]] # most sig down
go2Gene[["GO:0004722"]] # most sig up

# GABA
go2Gene[["GO:0046982"]] # most sig up
go2Gene[["GO:0004553"]] # most sig down
```
